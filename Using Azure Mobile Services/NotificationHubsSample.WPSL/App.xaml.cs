...
using NotificationHubsSample.Resources;

namespace NotificationHubsSample
{
    public partial class App : Application
    {
        public static MobileServiceClient NotificationHubsSampleAMSClient { get; set; }
        ...
        public App()
        {
            NotificationHubsSampleAMSClient = new MobileServiceClient(Constants.AMSEndpoint, Constants.AMSKey);
