...
#End If
    ...
    Private Async Sub Login_Click(sender As Object, e As RoutedEventArgs)
        ...
        Try
            ...
            Dim user__1 = User.Text
            Dim pwd = Password.Password

            ' Define a registration to pass in the body of the POST request.
            Dim registration = New Dictionary(Of String, String)() From { _
                {"platform", "windows"}, _
                {"instId", installationId}, _
                {"channelUri", channel.Uri} _
            }
            ...
            Dim auth = "Basic " + Convert.ToBase64String(Encoding.UTF8.GetBytes(user__1 + ":" + pwd))
